...
RSpec.describe FoodsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new food" do

        post :create, params: {food: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(food_url(Food.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new food" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the food" do
        food = Food.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the food" do
        food = Food.create! valid_attributes
